<nav class="bg-yellow-100 border-gray-200 dark:bg-gray-900 sticky top-0 z-20">
  <div class="max-w-screen flex flex-wrap items-center justify-between lg:px-10 px-7 py-4">
    <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
      ...
      <span class="font-sans self-center font-semibold text-sm antialiased whitespace-nowrap dark:text-white flex flex-col">
    ...
    <button data-collapse-toggle="navbar-default" type="button"
      class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg lg:hidden hover:bg-yellow-100 focus:outline-none focus:ring-2 focus:ring-yellow-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
    ...
    <div class="hidden w-full lg:block lg:w-auto" id="navbar-default">
      <ul class="font-medium flex flex-col p-4 lg:p-0 mt-4 rounded-lg bg-yellow-100 lg:flex-row lg:space-x-8 rtl:space-x-reverse lg:mt-0 lg:border-0 lg:bg-yellow-100 dark:bg-gray-800 lg:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <a href="/artikel"
            class="block py-2 px-3 text-gray-900 rounded hover:bg-yellow-200 lg:hover:bg-transparent lg:border-0 lg:hover:text-yellow-700 lg:p-0 dark:text-white lg:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent text-sm"
          >Mengenal Kartar</a>
        </li>
        <li>
          <a href="#"
        ...
        @else
          <li>
            <a href="/login"
              class="block py-2 px-3 text-gray-900 rounded hover:bg-yellow-200 lg:hover:bg-transparent lg:border-0 lg:hover:text-yellow-700 lg:p-0 dark:text-white lg:dark:hover:text-yellow-500 dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent text-sm"
              >Login</a>
          </li>
        @endauth
      </ul>
